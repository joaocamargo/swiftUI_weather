    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                MainWeatherView(imageName: isNight ? "moon.stars.fill" : "cloud.sun.fill", temperature: 18)
                ...
                Button {
                    ...
                    WeatherButton(title: "Change Day Time", textColor: .blue, backgroundColor: .white)//.contentShape(Rectangle())
                }
